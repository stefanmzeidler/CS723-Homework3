...
class CLFTrainer:
    def __init__(self, data_file: str = None):
        self.data = pd.read_csv(data_file, sep=None, engine='python', names=['target', 'features'], header=None,
                                usecols=[0, 5])
...
def main():
    ...
    if os.path.isfile(classifier_file):
        ...
        filepath = os.path.join(cur_dir, 'Datasets', 'testdata.manual.2009.06.14.csv')
